...
@record class StaticScheduler(bridges: MSZ[art.Bridge],
                              staticSchedule: DScheduleSpec,
                              staticScheduleInfoProvider: StaticScheduleInfoProvider) extends Scheduler {
